...
const Hero = () => {
  return (
    <Carousel className="mt-5" aria-label="Carrusel de imágenes promocionales">
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={image1}
          alt="Imagen de componente de PC"
          aria-label="Componente de PC en oferta"
        />
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src={image2}
          alt="Imagen de periférico de PC"
          aria-label="Periférico de PC en oferta"
        />
        <Carousel.Caption></Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
